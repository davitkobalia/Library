...
public class UserDataInitializer implements CommandLineRunner {
    ...
    public UserDataInitializer(UserRepository userRepository, RoleRepository roleRepository, BookRepository bookRepository, PatronRepository patronRepository) {
